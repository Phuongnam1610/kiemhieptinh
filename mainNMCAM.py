from adb import *
import numpy as np
pkgame="com.gbc.jx2mobile"
pkgame2="com.gbc.jx2mobile/org.cocos2dx.cpp.AppActivity"
...
class toolLQ():
        ...
        for i in range(100):
            ...
            # if (findFor(self.udid, 5, "dichuyen.png", 0)!= 0):
                # for i in range(50):
                    ...
                    time.sleep(5)
                    sc=screen_capture(self.udid)
                    sc2=sc[18:65,802:896]
                    if(find3(sc2,sc1,threshold=0.99)!=0):
                        sc=screen_capture(self.udid)
                        scload=sc[512:530,1:64]
                        if(find2(scload,"loadgame.png",threshold=0.95)!=0):
                            time.sleep(10)
                            print('dang load')
                            continue
                        else:
    ...
    def chuduocdiem(self):
        ...
        for i in range(2):
            ...
            if (findFor(self.udid, 1, "dichuyen.png", 0)!= 0):
                ...
                for i in range(10):
                    self.dungdi()
                    click(self.udid,476,241,"xaphu")
                    countFindLoad=0
                    for i in range(10):
                        sc=screen_capture(self.udid)
                        scload=sc[512:530,1:64]
                        if(find2(scload,"loadgame.png",threshold=0.95)!=0):
                            countFindLoad=countFindLoad+1
                            break
                    if(countFindLoad>0):
                        print("dang load")
                        continue
        ...
        if(self.tatauto()==True):
            for i in range(2):
                ...
                if (findFor(self.udid, 1, "dichuyen.png", 0)!= 0):
                    ...
                    time.sleep(5)
                    # click(self.udid, 263, 355,"duong mon ")
                    # time.sleep(5)
                    # click(self.udid,660,215,"duong thien hai")
                    # time.sleep(5)
                    # self.dungdi()
                    
                    # click(self.udid,814,212,"Thoai")
                    # time.sleep(5)
                    # click(self.udid,316,372,"mua")
                    # time.sleep(3)
                    # --
    ...
    def suachua(self):
        for i in range(2):
            ...
            time.sleep(1)
            click(self.udid, 192,141,"o so 2" )
            time.sleep(1)
            findFor(self.udid, 1, "dongy3.png",1,threshold=0.8 )
            time.sleep(1)
            click(self.udid, 185,200,"o so 3" )
            time.sleep(1)
            findFor(self.udid, 1, "dongy3.png",1,threshold=0.8 )
            time.sleep(1)
            click(self.udid, 183,387,"o cuoi" )
            time.sleep(1)
            findFor(self.udid, 1, "dongy3.png",1,threshold=0.8 )
            time.sleep(1)
        ...
        for i in range(2):
            ...
            if (findFor(self.udid, 1, "dichuyen.png", 0)!= 0):
                ...
                for i in self.index:
                    ...
                    #     if(find3(sc2,sc1,threshold=0.95)!=0):
                    #         clickTC=False
                    #     else:
                    #         clickTC=True
                    #         break
    ...
    def suDungTB(self):
        for i in range(2):
            ...
            click(self.udid,787,126,"o so 1")
            time.sleep(5)
            if (findFor(self.udid, 1, "tamtokiem.png", yclick=1,threshold=0.8)!= 0):
                time.sleep(5)
        ...
        if(self.vDL()==True):
                ...
                if (findFor(self.udid, 1, "hanhtrang.png", 0)!= 0):
                    ...
                    if(self.bando()==True):
                            time.sleep(4)
                        # if(self.buffmau()==True):
                            swipe(self.udid,83,446,142,330,2000)
                            if(self.lenbai()==True):
                                    time.sleep(3)
                                    self.batauto()
                                    return True
    ...
    def main(self):
        while True:
            ...
            a=False
            for i in range(5):
                if (findFor(self.udid, 1, "batdaucam.png",1 )!= 0):
                    a=True
