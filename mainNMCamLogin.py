...
def cam(img):
    ...
    return found
class toolLQ():
    def __init__(self,udid,index,u):
        self.udid=udid    
        self.index=index
        self.u=u
    def test(self):
    ...
    def lenbai(self):
        for i in range(2):
            ...
            if (findFor(self.udid, 1, "dichuyen.png", 0)!= 0):
                ...
                # for i in range(3):
                #     if(findFor(self.udid, 1, "xaphu1.png", 1,threshold=0.9)!=0):
                #         break
                #     if(findFor(self.udid, 1, "xaphu2.png", 1,threshold=0.9)!=0):
                #         break
                #     if(findFor(self.udid, 1, "xaphu3.png", 1,threshold=0.9)!=0):
                #         break
                #     if(findFor(self.udid, 1, "xaphu4.png", 1,threshold=0.9)!=0):
                #         break
                #     # if(findFor(self.udid, 1, "xaphu5.png", 1,threshold=0.9)!=0):
                #     #     break
